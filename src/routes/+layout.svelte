...
{#if showDisclaimer}
	...
	>
		<div
  			style="
				width: min(calc(100% - 16px), 97%); 
				height: min(calc(100% - 16px), 94%);
				max-width: 1400px;
				max-height: 750px;
  			"
		...
		>
  			<div class="p-5 w-full h-full overflow-auto">
				...
				<b class="text-left">Before you can use the O-RAN ChatBot ChatBot, please read this disclaimer:<br/><br/></b>
				<p class="text-left">
