<script>
	...
	onMount(async () => {
		// gen and store userID
		console.log('onMount running'); // Confirm onMount fires
		if (!userID) {
			userID = generateRandomID();
			localStorage.setItem('userID', userID);
			console.log('New userID set:', userID); // Log new ID
		}
...
{#if showDisclaimer}
	...
	>
		<div
			class="p-2 w-11/12 max-w-screen-xl bg-gray-800 dark:bg-gray-900 text-center text-white dark:text-gray-100 overflow-auto max-h-[85vh]"
		>
			<div class="p-4">
				<img
					src="/assets/images/HumanSubjectResearchProtection.png"
					alt="Northeastern University - Human Subject Research Protection"
					class="mb-4 mx-auto max-w-[250px] h-auto"
				/>
				...
				<p class="text-left">
					...
					with a quantitative input. The survey will take less than a minute to complete for every prompt.<br
					/><br />
